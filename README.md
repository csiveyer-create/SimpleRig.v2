...
## Cinematic professional UI overhaul

This build retains the existing SimpleRig features while redesigning the interface:

- cinematic dark steel-blue visual system;
- compact professional primary navigation;
- simplified drawing toolbar;
- dedicated Rig Analysis console;
- clearer line-tension input and haul-end workflow;
- larger, more visible drag-and-drop asset previews;
- GitHub-safe slug filenames for every supplied image;
- resilient image loading with visible missing-asset feedback;
- upgraded project, calendar, calculator and harness styling.

All local image paths were checked against the packaged asset files before export.
